...
passwordRules: [
  ...
  methods: {
    submitForm() {
      if (this.formIsValid) {
        axios
          .post(`${base_url}/signup`, { firstName: this.firstName, lastName: this.lastName, email: this.email, phoneNumber: this.phoneNumber, password: this.password, role: this.role })
          .then((res) => {
